...
import {
  render, createContent, createSidebar, taskInput,
} from './DOM';
...
const secondTask = new Task('Gym', 'LEG DAY. Hamstring curls; Bulgarian Split Squats (drop set), Romanian Deadlifts, Leg press, Calf Raises', '2022-06-14', 'Health');
